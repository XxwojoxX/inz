...
<body>
	...
	<div class="site-container"id="site-container">
		<div class="section-container" id="section-container">
			<div class="section" id="section">
				...
				<div class="ui-card" id="ui-card">
					<img src="images/1.png" alt="wstaw zdjecie strony glownej">
				...
				<div class="ui-card">
					<img src="images/1.png" alt="wstaw zdjecie sklepu">
					<div class="description">
						<h3>Sklep</h3>
						<h3>krotki opis</h3>
						<a href="shop.php">Zobacz</a>
					</div>
				</div>

				<div class="ui-card">
					<img src="images/1.png" alt="wstaw zdjecie aktualnosci">
					<div class="description">
						<h3>Aktualności</h3>
						<h3>krotki opis</h3>
						<a href="news.php">Zobacz</a>
					</div>
				</div>

				<div class="ui-card">
					<img src="images/1.png" alt="wstaw mieszanke zdjec zwierzat">
					<div class="description">
						<h3>Zwierzęta</h3>
						<h3>krotki opis</h3>
						<a href="animals.php">Zobacz</a>
					</div>
				</div>

				<div class="ui-card">
					<img src="images/1.png" alt="wstaw wykadrowany kalendarz">
					<div class="description">
						<h3>Wydarzenia</h3>
						<h3>krotki opis</h3>
						<a href="#events.php">Zobacz</a>
					</div>
				</div>

				<div class="ui-card">
					<img src="images/1.png" alt="wstaw zdjecie z wieloma numerami/mailami">
					<div class="description">
						<h3>Kontakt</h3>
						<h3>krotki opis</h3>
						<a href="contact.php">Zobacz</a>
					</div>
				</div>
			</div>
		</div>
	...
	<footer>
		...
		<div class="card">
			...
			<a class="socialContainer containerTwo" href="https://twitter.com/">
			...
			<a class="socialContainer containerThree" href="https://pl.linkedin.com/?trk=guest_homepage-basic_nav-header-logo">
			...
			<a class="socialContainer containerFour" href="https://www.whatsapp.com/">
